...
if __name__ == '__main__':
  ...
  if not (download_dapreq and download_active):
    ...
    send_email(sender, sysop, subject, front_matter, html2text(front_matter))
    exit()
  ...
  * {
  ...
  send_email(sender, sysop, subject, parse_report, html2text(parse_report))
